...
export const seed = {
  ...
  events: [{ ...makeBase(), title: "Sync semanal", description: "", start_time: new Date().toISOString(), end_time: new Date(Date.now()+3600000).toISOString(), source: "manual" }] as CalendarEvent[],
